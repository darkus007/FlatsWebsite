...
class Project(models.Model):
    ...
    url = models.CharField(null=True, blank=True, max_length=255, verbose_name='URL')
    metro = models.CharField(null=True, blank=True, max_length=127, verbose_name='Метро')
...
class Flat(models.Model):
    ...
    bulk = models.CharField(null=True, blank=True, max_length=127, verbose_name='Корпус')
...
class Price(models.Model):
    ...
    booking_status = models.CharField(null=True, blank=True, max_length=15, verbose_name='Бронь')
    data_created = models.DateField(auto_now_add=True, verbose_name='Опубликовано')

    flat = models.ForeignKey('Flat', on_delete=models.PROTECT, related_name='prices')
